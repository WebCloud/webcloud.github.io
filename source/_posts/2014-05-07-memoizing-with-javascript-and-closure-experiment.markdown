...
_PS: I know that Resig don't say that the code demonstrated on his book is the best way to do memoizing, I'm just making an experiment on the same subject grabbing his code to demonstrate the importance of the closures_
