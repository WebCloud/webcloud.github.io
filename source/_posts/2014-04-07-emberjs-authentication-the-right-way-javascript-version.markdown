...
{% codeblock app/assets/javascript/models/api_key.js lang:javascript %}
...
{% codeblock app/assets/javascript/controllers/application_controller.js lang:javascript start:3 %}
